...
def board(board: Optional[chess.BaseBoard] = None, *,
    ...
    for square, bb in enumerate(chess.BB_SQUARES):
        ...
        y = (7 - rank_index if orientation else rank_index) * SQUARE_SIZE + margin
        cls = ["darksquare"]
        #print(str(file_index) + " " + str(rank_index))
        #chess.square()
        #print(chess.BaseBoard.attackers()
        #print(chess.square_name(chess.square(file_index, rank_index)) + " white")
        white_attacks = len(chess.BaseBoard.attackers(board, 1, chess.square(file_index, rank_index)))
        black_attacks = len(chess.BaseBoard.attackers(board, 0, chess.square(file_index, rank_index)))
        # if white_attacks + black_attacks >= 6:
        #     cls = ["HEAT6"]
        # elif white_attacks + black_attacks == 9:
        #     cls = ["HEAT9"]
        # elif white_attacks + black_attacks == 8:
        #     cls = ["HEAT8"]
        # elif white_attacks + black_attacks == 7:
        #     cls = ["HEAT7"]
        # elif white_attacks + black_attacks == 6:
        #     cls = ["HEAT6"]
        # elif white_attacks + black_attacks == 5:
        #     cls = ["HEAT5"]
        # elif white_attacks + black_attacks == 4:
        #     cls = ["HEAT4"]
        # elif white_attacks + black_attacks == 3:
        #     cls = ["HEAT3"]
        # elif white_attacks + black_attacks == 2:
        #     cls = ["HEAT2"]
        # elif white_attacks + black_attacks == 1:
        #     cls = ["HEAT1"]
        # else:
        #     cls = ["HEAT0"]

        if white_attacks - black_attacks >= 5:
            cls = ["W5P5"]
        elif white_attacks - black_attacks == 4:
            if white_attacks >= 5:
                cls = ["W4P5"]
            ...
            if white_attacks >= 5:
                ...
                cls = ["W1P3"]
            elif white_attacks == 2:
                cls = ["W1P2"]
            else:
                cls = ["W1P1"]
        elif white_attacks == black_attacks:
            if white_attacks >= 5:
                cls = ["T5"]
            elif white_attacks == 4:
                cls = ["T4"]
                ...
                cls = ["T2"]
            elif white_attacks == 1:
                cls = ["T1"]
            else:
                cls = ["T0"]
        elif black_attacks - white_attacks == 1:
            if black_attacks >= 5:
                cls = ["B1P5"]
            elif black_attacks == 4:
                cls = ["B1P4"]
            elif black_attacks == 3:
                cls = ["B1P3"]
            elif black_attacks == 2:
                cls = ["B1P2"]
            else:
                cls = ["B1P1"]
        elif black_attacks - white_attacks == 2:
            if black_attacks >= 5:
                cls = ["B2P5"]
            elif black_attacks == 4:
                cls = ["B2P4"]
                ...
                cls = ["B2P2"]
        elif black_attacks - white_attacks == 3:
            if black_attacks >= 5:
                cls = ["B3P5"]
            elif black_attacks == 4:
                cls = ["B3P4"]
                ...
                cls = ["B3P3"]
        elif black_attacks - white_attacks == 4:
            if black_attacks >= 5:
                cls = ["B4P5"]
            else:
                cls = ["B4P4"]
